...
import { getNextRelevantMoment, getPreviousRelevantMoment } from "./BuildOrder";
...
function readCountDown(
  ...
  countDownTimeout: React.MutableRefObject<null | number>
) {
...
const SpeedControls: React.FC<ISpeedControlsProps> = ({
  playing,
  buildOrder,
  togglePlaying,
  gameTime,
  ...
  const longPressEventForward = useLongPress(
    buildStepHandler(handleFastForward),
    buildStepHandler(handleFastForward),
    defaultOptions
  );
  const longPressEventBackward = useLongPress(
    buildStepHandler(handleRewind),
    buildStepHandler(handleRewind),
    defaultOptions
  );
  ...
  return (
    <div className="play-controls">
      <div
        className="speedcontrol-button back"
        {...longPressEventBackward}
      ...
      <div
        className="speedcontrol-button forward"
        {...longPressEventForward}
        onContextMenu={disableContextMenu}
      >
